...
source=(
  ...
  winecfg-Add-checkbox-to-enable-ALSA-driver.patch
)
sha512sums=(
  'SKIP'
  'SKIP'
  ...
  '675ad5cd3b99c5b7eb042f04a7575519b66cdb0311483cb7d63f3807bb13435af19a68fac94919d1a843439afb1b9b1a672eadfe6458c95a51432e8526bc5b51'
)
...
prepare() {
  ...
  # Add checkbox to enable ALSA in winecfg
  patch -Np1 -i "${srcdir}/winecfg-Add-checkbox-to-enable-ALSA-driver.patch"
